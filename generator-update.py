...
producer = Producer({'bootstrap.servers': 'kafka:9092'})  # Kafka producer
...
def generate_data():
    ...
    producer.produce('stock-data', data.encode('utf-8'))  # Send to Kafka topic
...
def generate_additional_data():
    ...
    producer.produce('additional-data', data.encode('utf-8'))  # Send to Kafka topic
    producer.flush()  # Ensure data is sent
    return data
